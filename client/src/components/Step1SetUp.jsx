    ...
    <motion.div
      ...
      <div className='w-full max-w-6xl bg-white rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden'>
        ...
        <motion.div
          ...
          className="relative bg-gradient-to-br from-green-50 to-green-100 flex flex-col justify-center p-12">
              ...
              <motion.div
                ...
                {resumeFile && (
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    disabled={analyzing}
                    className="mt-4 bg-green-600 hover:bg-green-700 disabled:bg-gray-400 disabled:cursor-not-allowed text-white px-4 sm:px-6 py-2 rounded-lg transition font-semibold whitespace-nowrap"
                  >
