...
import {AreaChart, CartesianGrid, ResponsiveContainer, Tooltip, Area,XAxis, YAxis} from "recharts"
...
export default function Step3Report({ report }) {
  ...
  const downloadPDF = ()=>{
    ...
    const splitAdive = doc.splitTextToSize(advice,contentWidth-20);
    doc.text(splitAdive,margin+10,currentY+20);
  ...
  return (
    <div className='min-h-screen bg-linear-to-br from-gray-50 to-green-50 px-4 sm:px-6 lg:px-10 py-8'>
      <div className='mb-8 flex flex-col sm:flex-row items-center sm:justify-between gap-4'>
        ...
        <button 
        onClick={downloadPDF}
        className='w-full sm:w-auto bg-emerald-600 text-nowrap hover:bg-emerald-700 text-white p-3 rounded-xl shadow-md transition-all duration-300 font-semibold text-sm sm:text-base'>
          Download PDF
        </button>
      </div>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8'>
        <div className='space-y-6'>
          <motion.div
            ...
            <div className='mt-4'>
              <p className='font-semibold text-gray-800 text-xs sm:text-sm mt-1'>
                {performanceText}
              </p>
        ...
        <div className='lg:col-span-2 space-y-6'>
              ...
              className='bg-white rounded-2xl sm:rounded-3xl shadow-lg p-5 sm:p-8'>
                  <h3
                  className='text-base sm:text-lg font-semibold text-gray-700 mb-4 sm:mb-6'>
                    Performance Trend
                  </h3>
                    ...
                    <div className='space-y-6'>
                        {questionWiseScore.map((q,i)=>(
                          <div key={i} className='bg-gray-50 p-4 sm:p-6 rounded-xl sm:rounded-2xl border border-gray-200'>
                              ...
                              <div className='flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3 md-4'>
                                  <div>
