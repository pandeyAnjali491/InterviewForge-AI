          ...
          <div className='text-center mb-28'>
            <motion.h1
              ...
              <span className='relative inline-block mt-1'>
                <span className='bg-green-100 text-green-600 px-5 rounded-full'>
                  AI Intelligence
                </span>
              </span>
            </motion.h1>
          ...
          <div className='flex flex-col md:flex-row justify-center items-center gap-10 mb-28'>
            {
              [
                ...
                ${index == 2 ? "rotate-[-3deg]" : ""}`}>
                    <div className='absolute -top-8 left-1/2 -translate-x-0.5 bg-white border-2 border-green-500 text-green-600 w-16 h-16 rounded-2xl flex items-center justify-center shadow-lg'>
                      {item.icon}
                    </div>
                  ...
                  <motion.div key={index}
                    ...
                    <div className='flex flex-col md:flex-row items-center gap-8'>
                      ...
                      <div className='w-full md:w-1/2'>
                        <div className='bg-green-50 text-green-600 w-12 h-12 rounded-xl flex items items-center justify-center mb-6'>
                          {item.icon}
                        </div>
